...
//
//    //==================================================
//    // STATES (Removed the unnecessary 'start' state)
//    //==================================================
...
//            case(current_state)
//
//                // Reset counter while waiting in IDLE
//                IDLE :
//                begin
//                    bit_counte <= 3'b000;
//                end
...
//            IDLE :
//            begin
//                // Detect START bit and jump straight to receiving
//                if(rx_in == 1'b0)
//                    next_state = receive;
//                else
//                    next_state = IDLE;
...
//
//    //==================================================
//    // INSTANTIATE THE SEPARATE BAUD GENERATOR
//    //==================================================
...
//            end
//            
//            // Only sample data when the separate module fires a full_tick
...
//            IDLE : begin
//                if(rx_in == 1'b0)
//                    next_state = start; // This automatically turns on baud_enable
//            end
//
//            start : begin
//                // Wait for the separate module to fire the half_tick
...
//
//            done : begin
//					 next_state = IDLE; // Returning to IDLE shuts off the baud module
//            end
//        endcase
//    end
//
...
module UART_rx (
    ...
    output reg [7:0] rx_data,
    output reg rx_done,
    output reg parity_err // NEW: Flags an error if the received parity is wrong!
);

    // STATES: Added 'check_p' and updated the binary values.
    parameter IDLE    = 3'b000;
    parameter start   = 3'b001;
    parameter receive = 3'b010;
    parameter check_p = 3'b011; // NEW: State to sample the parity bit
